...
void StartKernel() {
    ...
    g_KFramebuffer.BaseAddress = VMM::g_KVMM->AllocateAnonPages(DIV_ROUNDUP(g_KFramebuffer.pitch * g_KFramebuffer.height, PAGE_SIZE), {VMM::Protection::READ_WRITE, VMM::CacheType::DEFAULT, false, true, false, true, true});
